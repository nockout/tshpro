...
<div id="sortable">
	...
	<!-- Begin Quick Links -->
	<?php if ($theme_options->tshirt_quick_links == 'yes') : ?>
	<div class="one_full">
	...
	<?php if (isset($recent_comments) AND is_array($recent_comments) AND $theme_options->tshirt_recent_comments == 'yes') : ?>
	<div class="one_full">
	...
	<?php if ((isset($analytic_visits) OR isset($analytic_views)) AND $theme_options->tshirt_analytics_graph == 'yes'): ?>
	...
	<!-- Begin RSS Feed -->
	<?php if ( isset($rss_items) AND $theme_options->tshirt_news_feed == 'yes') : ?>
