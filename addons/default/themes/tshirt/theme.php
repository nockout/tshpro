...
class Theme_Tshirt extends Theme {
    ...
    public $name			= 'tshirt - Admin Theme';
	...
	public $type			= 'admin';
	public $options 		= array('tshirt_recent_comments' => array('title' 		=> 'Recent Comments',
									...
									'tshirt_news_feed' => 			array('title' => 'News Feed',
									...
									'tshirt_quick_links' => 		array('title' => 'Quick Links',
									...
									'tshirt_analytics_graph' => 	array('title' => 'Analytics Graph',
