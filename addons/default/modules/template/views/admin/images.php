...
<?php if(!$id_template):?>
							<div class="">
		<fieldset>
			<div class="block-message warning"><?php echo lang("template:save_product_before_add_image")?></div>
		</fieldset>
	</div>
<?php else:?>
<fieldset>
    	...
    	<![endif]-->
			...
			<?php $attribute=array('id'=>'fileupload');$hiddens=array("id_template"=>$id_template,'type'=>'FRONT')?>
			<?php echo form_open_multipart('admin/template/img_upload',$attribute,$hiddens); ?>		
...
<!-- 							<span>Add files...</span>  -->
							<input title="" type="file" name="files[]" multiple>
<!-- 						</span> -->
...
<!--            <p class="name">
        ...
        <td>
            ...
            <input type="radio" url_default="{%=file.url_default%}"  name="default" value="{%=file.id_image%}" class="toggle">
        </td>
    </tr>
{% } %}
</script>
    	...
    	<![endif]-->
			<!-- The file upload form used as target for the file upload widget -->
			<?php $attribute=array('id'=>'fileupload_back');$hiddens=array("id_template"=>$id_template,'type'=>'BACK')?>
			<?php echo form_open_multipart('admin/template/img_upload',$attribute,$hiddens); ?>		

				<div class="fileupload-buttonbar">
					<div class="fileupload-buttons">

<!-- 						<span id="fileinput-button-back" class="fileinput-button button  ">  -->
<!-- 							<span>Add files...</span>  -->
...
<!--            <p class="name">
        ...
        <td>
            <button class="delete" data-type="{%=file.deleteType%}" data-url="{%=file.delete_url%}"{% if (file.deleteWithCredentials) { %} data-xhr-fields='{"withCredentials":true}'{% } %}>Delete</button>
            <input type="radio" url_default="{%=file.default%}" name="default" value="{%=file.id_image%}" class="toggle">
        </td>
    </tr>
{% } %}
</script>
