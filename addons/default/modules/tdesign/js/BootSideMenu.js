(function ( $ ) {
	...
	$.fn.BootSideMenu = function( options ) {
		...
		newCode += "	<span class=\"glyphicon glyphicon-chevron-right icon icon-chevron-right\">&nbsp;</span> <span class=\"glyphicon glyphicon-chevron-left icon icon-chevron-left\">&nbsp;</span>\n";
		newCode += "</div>\n";
