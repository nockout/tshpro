...
//adds
$add_image_btn = isset($_POST['addImageButton']) ? $_POST['addImageButton'] : lang("design:add_your_image");
$add_text_btn = isset($_POST['addTextButton']) ? $_POST['addTextButton'] : lang("design:add_your_own_text");
