...
<div class="designContainer" id="printable" style="position:relative;width:<?php echo $original->width ?>px;height:<?php echo $original->height ?>px">
	...
	<div class="text t designtext1 no-delete">
		...
		<img id="Tshirtsrc"
		src="<?php echo get_image_path_temp($first_t["resize_image"])?>"
