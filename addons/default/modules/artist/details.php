 ...
 */
class Module_Artist extends Module
{
	...
	public function info()
	{
		$info = array(
			'name' => array(
				'en' => 'Artist design',
				'vi' => 'Chuc nang Thiet ke ',
			),
			'description' => array(
				'en' => 'Allows user design sample clothers.',
				'vi' => 'Cho phép nguoi thiet ke design mau',
			),
			'frontend' => false,
			'backend' => true,
			'menu' => false,
...
// 			),
	...
	public function admin_menu(&$menu)
	{
		...
		$menu['lang:cp:nav_design']['lang:cp:nav_design_create'] = array(
				'lang:design:create'=> 'admin/artist/create_design',
		...
		$menu['lang:cp:nav_design']['lang:cp:nav_design_management'] = array(
				...
				'lang:design:management'=> 'admin/artist/manage/arts'
		);
		//echo "<pre>";
		//print_r($menu);die;
