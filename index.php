...
if ( ! file_exists('system/backoffice/config/database.php'))
{
	// Make sure we've not already tried this
	if (strpos($_SERVER['REQUEST_URI'], 'installer/'))
	{
		header('Status: 404');
		exit('PyroCMS is missing system/backoffice/config/database.php and cannot find the installer folder. Does your server have permission to access these files?');
	}
 ...
 *
 */
	$application_folder = 'system/backoffice';
