...
$lang['cp:welcome_message'] 			= 'Tervetuloa sivuston %s hallintapaneeliin. Käyttämällä yläpuolella ja vasemmalla olevia linkkejä, voit hallinnoida kattavasti koko sivustoa. Jos järjestelmän kanssa ilmenee ongelmia, pyydämme teitä ottamaan yhteyttä meidän bugi seurantaan.';

$lang['cp:news_feed_title'] 			= 'Uutissyöte';

// Shortcuts
$lang['cp:manage_comments']				= 'Hallitse kommentteja';
$lang['cp:manage_pages']				= 'Hallitse sivuja';
$lang['cp:manage_files']				= 'Hallitse tiedostoja';
$lang['cp:manage_users']				= 'Hallitse käyttäjiä';

// Header
$lang['cp:to_home'] 					= 'Takaisin dashboardiin';
$lang['cp:view_frontend'] 				= 'Selaa sivuja';
$lang['cp:logged_in_welcome'] 			= 'Hei %s';
$lang['cp:logout_label'] 				= 'Kirjaudu ulos';
$lang['cp:edit_profile_label'] 			= 'Muokkaa profiilia';

// Footer
$lang['cp:change_language'] 			= 'Vaihda kieli';
$lang['cp:documentation'] 				= 'Dokumentointi';
$lang['cp:report_bug'] 					= 'Raportoi bugista';
$lang['cp:contact_support'] 			= 'Tuki';

$lang['cp:nav_settings']				= 'Asetukset';
