...
$lang['cp:welcome_message'] 			= 'Bem vindo(a) ao Painel de Controlo de %s. Utilizando os links do menu pode controlar quase todos os aspectos do seu site. Se encontrar alguma dificuldade com o sistema, por favor, envie uma notificação do problema para o nosso bug tracker.';

$lang['cp:news_feed_title'] 			= 'Feed de notícias';

// Shortcuts
$lang['cp:manage_comments']				= 'Gerir comentários';
$lang['cp:manage_pages']				= 'Gerir páginas';
$lang['cp:manage_files']				= 'Gerir ficheiros';
$lang['cp:manage_users']				= 'Gerir utilizadores';

// Header
$lang['cp:to_home'] 					= 'Voltar para a Dashboard';
$lang['cp:view_frontend'] 				= 'Ver site';
$lang['cp:logged_in_welcome'] 			= 'Olá %s';
$lang['cp:logout_label'] 				= 'Sair';
$lang['cp:edit_profile_label'] 			= 'Editar perfil';

// Footer
$lang['cp:change_language'] 			= 'Alterar idioma';
$lang['cp:documentation'] 				= 'Documentação';
$lang['cp:report_bug'] 					= 'Notificar um erro';
