...
$lang['cp:admin_title'] 			= 'Vezérlőpult';
$lang['global:dashboard'] 			= 'Műszerfal';
$lang['cp:admin_quick_links']			= 'Gyors linkek';

$lang['cp:welcome_title'] 			= 'Üdv';
$lang['cp:welcome_message'] 			= 'Üdv a(z) %s oldal vezérlőpultján. A fenti linkek segítségével lehet irányítani a weboldalt, gyakorlatilag bármely aspektusból. Hibákat bejelenteni az azok számára létrehozott menüpontban lehet.';

$lang['cp:news_feed_title'] 			= 'Hírcsatorna';

// Shortcuts
$lang['cp:manage_comments']			= 'Hozzászólások kezelése';
$lang['cp:manage_pages']			= 'Oldalak kezelése';
$lang['cp:manage_files']			= 'Fájlok kezelése';
$lang['cp:manage_users']			= 'Felhasználók kezelése';

// Header
$lang['cp:to_home'] 				= 'Vissza a műszerfalhoz';
$lang['cp:view_frontend'] 			= 'A weboldal megtekintése';
$lang['cp:logged_in_welcome'] 			= 'Helló %s';
$lang['cp:logout_label'] 			= 'Kijelentkezés';
$lang['cp:edit_profile_label'] 			= 'Profil módosítása';

// Footer
$lang['cp:change_language'] 			= 'Nyelv választás';
$lang['cp:documentation'] 			= 'Leírás';
$lang['cp:report_bug'] 				= 'Hibajelentés';
$lang['cp:contact_support'] 			= 'Támogatás';

$lang['cp:nav_settings']			= 'Beállítások';
