...
$lang['cp:delete_installer']					 = 'Installationsverzeichnis löschen';
$lang['cp:delete_installer_successfully_message'] = 'Das Installationsverzeichnis wurde erfolgreich gelöscht.';
$lang['cp:delete_installer_manually_message']     = 'Das Installationsverzeichnis konnte nicht gelöscht werden. <strong>Bitte entferne es manuell!</strong>';
...
$lang['cp:google_analytics_missing']	= 'Deine Google Analytics Einstellungen fehlen. Bitte füge Sie in %s hinzu oder kontaktiere einen Administrator.';
$lang['cp:google_analytics_no_connect']	= 'Keine Verbindung zu Google Analytics möglich. Bitte in %s prüfen.';
