...
$lang['nav:link_target_self'] 					= 'Janela atual (default)';
...
$lang['nav:group_delete_confirm'] 				= 'Você tem certeza que deseja remover este grupo de navegação? ISto irá apagar TODOS os links de navegação dentro deste grupo, sendo que será necessário editar os arquivos de layout manualmente para remover as referências existentes.';
$lang['nav:group_add_success'] 					= 'Seu grupo de navegação foi salvo.';
