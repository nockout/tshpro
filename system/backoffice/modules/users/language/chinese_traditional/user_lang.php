...
$lang['user:add_field']                        	= '新增用戶資料欄位';
$lang['user:profile_delete_success']           	= '用戶資料欄位刪除成功';
$lang['user:profile_delete_failure']            = '刪除資料欄位時發生了錯誤。';
$lang['profile_user_basic_data_label']  		= '基本資料';
$lang['profile_company']         	  			= '公司';
$lang['profile_updated_on']           			= '更新於';
$lang['user:profile_fields_label']	 		 	= '資料欄位';

$lang['user:register_header'] 			= '註冊';
$lang['user:register_step1'] 			= '<strong>步驟一：</strong> 註冊';
$lang['user:register_step2'] 			= '<strong>步驟二：</strong> 啟動';
...
$lang['user:registration_disabled']         = '抱歉，使用者註冊功能已經關閉。';
...
$lang['user:register_error']				    = '您的操作被系統判斷為自動程式，如果是誤判了，那麼請接受我們的道歉。';
