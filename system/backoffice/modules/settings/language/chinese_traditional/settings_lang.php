...
$lang['settings:ckeditor_config']               = 'CKEditor 設定'; #translate
$lang['settings:ckeditor_config_desc']          = '您可以在「<a target="_blank" href="http://docs.cksource.com/ckeditor_api/symbols/CKEDITOR.config.html">CKEditor\'s 線上文件.</a>」中查閱到可以使用的設定項目。'; #translate

$lang['settings:enable_registration']           = '開啟使用者註冊';
$lang['settings:enable_registration_desc']      = '讓訪客可以在你的網站註冊成為用戶。';
...
$lang['settings:cdn_domain_desc']               = 'CDN domains 讓你可以使用一些知名伺服器上的固定內容, 像是 Amazon CloudFront 或 MaxCDN. If you do not have a CDN provider try MaxCDN. <a href="'.CDN_OFFER_URL.'" target="_blank">Sign up and save 25%.</a>'; #translate
