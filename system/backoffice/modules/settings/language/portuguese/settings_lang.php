...
$lang['settings:cdn_domain_desc']               = 'CDN domínios permite descarregar conteúdos estáticos para servidores de borda diferentes, como, Amazon CloudFront ou MaxCDN. If you do not have a CDN provider try MaxCDN. <a href="'.CDN_OFFER_URL.'" target="_blank">Sign up and save 25%.</a>'; #translate
