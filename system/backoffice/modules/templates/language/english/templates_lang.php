...
$lang['templates:tmpl_clone_error']			= '"%s" was unable to be cloned.  Please try again.';
$lang['templates:single_delete_success']	= 'The email template has been deleted.';
$lang['templates:mass_delete_success']		= '%s email templates out of %s successfully deleted.';
$lang['templates:mass_delete_error'] 		= 'Error occurred while trying to delete email template "%s".';
$lang['templates:default_delete_error'] 	= 'Error occurred, default email templates can not be removed.';
$lang['templates:no_select_error'] 			= 'You need to select email templates first.';
