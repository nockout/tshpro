...
$lang['pages:page']                     = 'Página';
$lang['pages:pages']                    = 'Páginas';

// tabs
$lang['pages:details_label']            = 'Detalhes da página';
...
$lang['pages:detail_label']             = 'Detalhes';
...
$lang['pages:meta_robots_no_index_label']  = 'Robots: Não indexem esta página:';
$lang['pages:meta_robots_no_follow_label'] = 'Robots: Não sigam links nesta página:';
$lang['pages:meta_desc_label']             = 'Meta descrição';
$lang['pages:type_id_label']               = 'Type da página';
...
$lang['pages:strict_uri_label']            = 'Requer uma correspondência exata de uri?';
...
$lang['pages:delete_home_error']        = 'Você não pode remover a  página inicial!';
...
$lang['pages:page_already_exist_error'] = 'Uma página com a URL "%s" já existe na página %s.';
$lang['pages:parent_not_exist_error']   = 'A página pai que você selecionou não existe.';
$lang['pages:chunk_slug_length']        = 'Slugs de Pedaços de Página não devem ter mais de 30 caracteres de comprimento.';
$lang['pages:root_folder']              = 'raiz';
