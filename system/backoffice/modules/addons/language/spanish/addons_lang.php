...
$lang['addons:modules:upload_desc']				= 'Por favor, elije un archivo y haz click en el botón "Subir"';
...
$lang['addons:themes:save_success']				= 'Las opciones del tema han sido guardadas.';
$lang['addons:themes:re-index_success']			= 'Las opciones del tema han sido re-indexadas';
$lang['addons:themes:no_options']				= 'Este tema no tiene opciones.';
$lang['addons:themes:set_default_success']		= 'El tema "%s" es ahora tu tema predeterminado.';
$lang['addons:themes:set_default_error']		= 'Imposible ajustar "%s" como tu nuevo tema predeterminado.';
$lang['addons:themes:already_exists_error']		= 'Ya hay un tema con este nombre.';
$lang['addons:themes:extract_error']			= 'Imposible extraer el tema.';
$lang['addons:themes:upload_success']			= 'Template subido exitosamente.';
$lang['addons:themes:default_delete_error']		= 'No puedes borrar el tema predeterminado.';
$lang['addons:themes:delete_error']				= 'Imposible eliminar el directorio "%s".';
$lang['addons:themes:mass_delete_success']		= '%s temas de %s disponibles fueron eliminados.';
$lang['addons:themes:mass_delete_error']		= 'Se han eliminado %s temas de un total de %s.';
$lang['addons:themes:delete_select_error']		= 'Debes seleccionar un tema para eliminar primero.';
$lang['addons:themes:upload_title']				= 'Subir tema';
...
$lang['addons:themes:default_theme_label']		= 'Tema predeterminado';
$lang['addons:themes:no_themes_installed']		= 'No hay temas instalados.';
