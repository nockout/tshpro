...
$lang['addons:admin_themes'] 					= 'سمات الإدارة';
...
$lang['addons:themes:re-index_success']			= 'تم إعادة فهرسة خيارات هذه السمة بنجاح.';
$lang['addons:themes:no_options']				= 'هذه السمة ليس لها أية خيارات.';
$lang['addons:themes:set_default_success']		= 'السّمة "%s" هي السّمة الافتراضيّة الجديدة.';
$lang['addons:themes:set_default_error']		= 'تعذر تعيين السّمة "%s" كسِمة افتراضيّة جديدة.';
$lang['addons:themes:already_exists_error'] 	= 'هناك سمة لها نفس الإسم.';
$lang['addons:themes:extract_error']			= 'تعذر استخراج ملفات السّمة.';
$lang['addons:themes:upload_success']			= 'تم رفع السّمة بنجاح.';
$lang['addons:themes:default_delete_error']		= 'لا يمكنك حذف السّمة الافتراضيّة.';
$lang['addons:themes:delete_error']				= 'تعذر حذف الدليل "%s".';
$lang['addons:themes:mass_delete_success'] 		= 'تم حذف %s سمات من %s ينجاح.';
...
$lang['addons:themes:theme_label'] 				= 'السّمة';
$lang['addons:themes:make_default']				= 'تعيين كافتراضيّة';
