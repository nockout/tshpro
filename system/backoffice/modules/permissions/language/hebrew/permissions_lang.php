...
$lang['permissions:group']                  = 'קבוצה';
$lang['permissions:roles']                  = 'תפקידים';
$lang['permissions:module']                      = 'Module'; #translate
$lang['permissions:edit']                   = 'ערוך הרשאות';

$lang['permissions:introduction']           = 'באפשרותך ליצור הרשאות מותאמות אישית עבור משתמשים שונים על ידי הקצאת אותם לקבוצות באזור משתמשים> ניהול משתמשים. לאחר מכן תוכל לערוך הרשאות עבור כל קבוצה ולשלוט איזו מודולים או "תפקידים" הקבוצה יכול להיות.';

$lang['permissions:message_group_saved_success']    = 'ההרשאות עבור קבוצה זו נשמרו בהצלחה.';
