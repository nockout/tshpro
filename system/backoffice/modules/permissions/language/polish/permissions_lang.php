...
$lang['permissions:group']		= 'Grupa';
$lang['permissions:roles']      = 'Role';
$lang['permissions:module']                      = 'Module'; #translate
$lang['permissions:edit']		= 'Edytuj uprawnienia';

$lang['permissions:introduction'] 	= 'Możesz tworzyć niestandardowe uprawnienia dla różnych użytkowników
        poprzez przypisanie ich do grup korzystając z menu Użytkownicy > Zarządzaj użytkownikami. Następnie możesz
        edytwoać uprawnienia dla każdej grupy i kontrolować do jakich modułów taka grupa ma dostęp.';

$lang['permissions:message_group_saved_success'] = 'Uprawnienia dla tej grupy zostały zapisane.';
