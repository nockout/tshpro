...
// labels
$lang['groups:title']					= 'Titolo';
$lang['groups:name']				    = 'Nome';
$lang['groups:short_name']				= 'Soprannome';

// titles
$lang['groups:index_title'] 			= 'Elenco dei Gruppi';
$lang['groups:add_title']				= 'Aggiungi un Gruppo';
$lang['groups:edit_title'] 				= 'Modifica il Gruppo "%s"';

// messages
$lang['groups:no_groups']				= 'Nessun gruppo trovato.';
$lang['groups:add_success'] 			= 'Il gruppo "%s" è stato aggiunto.';
$lang['groups:add_error'] 				= 'Il gruppo "%s" non può essere aggiunto.';
